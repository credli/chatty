...
<b>          const updatedGroup &#x3D; _.find(userData.user.groups, { id: createMessage.groupId });</b>
<b>          if (!updatedGroup.messages.length ||</b>
<b>            moment(updatedGroup.messages[0].createdAt).isBefore(moment(createMessage.createdAt))) {</b>
<b>            // update the latest message</b>
<b>            updatedGroup.messages[0] &#x3D; createMessage;</b>
<b></b>
