...
<b>import { executableSchema } from &#x27;./data/schema&#x27;;</b>
...
<b>          variables: { groupIds: [nextProps.navigation.state.params.groupId] },</b>
...
<b>        document: MESSAGE_ADDED_SUBSCRIPTION,</b>
<b>        variables: { groupIds: map(user.groups, &#x27;id&#x27;) },</b>
<b>        updateQuery: (previousResult, { subscriptionData }) &#x3D;&gt; {</b>
...
<b>export const wsClient &#x3D; new SubscriptionClient(&#x27;ws://localhost:8080/subscriptions&#x27;, {</b>
  reconnect: true,
  connectionParams: {
